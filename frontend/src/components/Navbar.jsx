...
function Navbar() {
  ...
  return (
    <div
      className={`max-w-screen-2xl dark:bg-slate-800 bg-white container mx-auto z-50 md:px-20 px-4 fixed top-0 left-0 right-0 ${
        sticky
      ...
      <div className="navbar">
        ...
        <div className="navbar-end space-x-3">
          ...
          <div className="hidden md:block">
            <label className="input flex items-center gap-2 bg-transparent outline-none">
              <input
                type="text"
                className="grow"
                placeholder="Search"
